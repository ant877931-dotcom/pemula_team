  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          const Text("Masukkan 6 Digit PIN Keamanan", style: TextStyle(fontSize: 13, color: Colors.grey)),
          ...
          TextField(
            ...
            maxLength: 6,
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: 24, letterSpacing: 10, color: colorBottom, fontWeight: FontWeight.bold),
